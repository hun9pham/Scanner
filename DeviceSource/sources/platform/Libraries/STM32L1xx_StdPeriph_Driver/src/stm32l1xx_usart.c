...
/**
  * @brief  Deinitializes the UART_CONSOLE peripheral registers to their default reset values.
  * @param  UART_CONSOLE: Select the USART peripheral. 
  *   This parameter can be one of the following values: USART1, USART2, USART3, 
  *   UART4 or UART5.
  * @retval None.
  */
void USART_DeInit(USART_TypeDef* UART_CONSOLE)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));

  if (UART_CONSOLE == USART1)
  {
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_USART1, ENABLE);
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_USART1, DISABLE);
  }
  else if (UART_CONSOLE == USART2)
  {
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_USART2, ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_USART2, DISABLE);
  }
  else if (UART_CONSOLE == USART3)
  {
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_USART3, ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_USART3, DISABLE);
  }    
  else if (UART_CONSOLE == UART4)
  {
...
/**
  * @brief  Initializes the UART_CONSOLE peripheral according to the specified
  ...
  * @retval None.
  */
void USART_Init(USART_TypeDef* UART_CONSOLE, USART_InitTypeDef* USART_InitStruct)
{
  ...
  {
    assert_param(IS_USART_123_PERIPH(UART_CONSOLE));
  }
   
/*---------------------------- USART CR2 Configuration -----------------------*/
  tmpreg = UART_CONSOLE->CR2;
  ...
  /* Write to USART CR2 */
  UART_CONSOLE->CR2 = (uint16_t)tmpreg;

/*---------------------------- USART CR1 Configuration -----------------------*/
  tmpreg = UART_CONSOLE->CR1;
  ...
  /* Write to USART CR1 */
  UART_CONSOLE->CR1 = (uint16_t)tmpreg;

/*---------------------------- USART CR3 Configuration -----------------------*/  
  tmpreg = UART_CONSOLE->CR3;
  ...
  /* Write to USART CR3 */
  UART_CONSOLE->CR3 = (uint16_t)tmpreg;
...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  if ((UART_CONSOLE->CR1 & USART_CR1_OVER8) != 0)
  {
    /* Integer part computing in case Oversampling mode is 8 Samples */
    integerdivider = ((25 * apbclock) / (2 * (USART_InitStruct->USART_BaudRate)));    
  }
  else /* if ((UART_CONSOLE->CR1 & CR1_OVER8_Set) == 0) */
  {
  ...
  /* Write to USART BRR */
  UART_CONSOLE->BRR = (uint16_t)tmpreg;
}
...
/**
  * @brief  Initializes the UART_CONSOLE peripheral Clock according to the 
  *         specified parameters in the USART_ClockInitStruct.
  * @param  UART_CONSOLE: where x can be 1, 2, 3 to select the USART peripheral.
  ...
  * @retval None.
  */
void USART_ClockInit(USART_TypeDef* UART_CONSOLE, USART_ClockInitTypeDef* USART_ClockInitStruct)
{
...
/**
  ...
  * @param  NewState: new state of the UART_CONSOLE peripheral.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None.
  */
void USART_Cmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR1 |= USART_CR1_UE;
  }
  else
  {
    /* Disable the selected USART by clearing the UE bit in the CR1 register */
    UART_CONSOLE->CR1 &= (uint16_t)~((uint16_t)USART_CR1_UE);
  }
}
...
/**
  ...
  * @retval None.
  */
void USART_SetPrescaler(USART_TypeDef* UART_CONSOLE, uint8_t USART_Prescaler)
{ 
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  
  /* Clear the USART prescaler */
  UART_CONSOLE->GTPR &= USART_GTPR_GT;
  /* Set the USART prescaler */
  UART_CONSOLE->GTPR |= USART_Prescaler;
}
...
/**
  ...
  * @retval None
  */
void USART_OverSampling8Cmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR1 |= USART_CR1_OVER8;
  }
  else
  {
    /* Disable the 8x Oversampling mode by clearing the OVER8 bit in the CR1 register */
    UART_CONSOLE->CR1 &= (uint16_t)~((uint16_t)USART_CR1_OVER8);
  }
}  
...
/**
  ...
  * @retval None.
  */
void USART_OneBitMethodCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_CR3_ONEBIT;
  }
  else
  {
    /* Disable the one bit method by clearing the ONEBITE bit in the CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_ONEBIT);
  }
}
...
/**
  * @brief  Transmits single data through the UART_CONSOLE peripheral.
  * @param  UART_CONSOLE: Select the USART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
  ...
  * @retval None.
  */
void USART_SendData(USART_TypeDef* UART_CONSOLE, uint16_t Data)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  ...
  /* Transmit Data */
  UART_CONSOLE->DR = (Data & (uint16_t)0x01FF);
}

/**
  * @brief  Returns the most recent received data by the UART_CONSOLE peripheral.
  * @param  UART_CONSOLE: Select the USART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
  * @retval The received data.
  */
uint16_t USART_ReceiveData(USART_TypeDef* UART_CONSOLE)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  
  /* Receive Data */
  return (uint16_t)(UART_CONSOLE->DR & (uint16_t)0x01FF);
}
...
/**
  ...
  * @retval None
  */
void USART_SetAddress(USART_TypeDef* UART_CONSOLE, uint8_t USART_Address)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  ...
  UART_CONSOLE->CR2 &= (uint16_t)~((uint16_t)USART_CR2_ADD);
  /* Set the USART address node */
  UART_CONSOLE->CR2 |= USART_Address;
}
...
/**
  ...
  * @retval None
  */
void USART_ReceiverWakeUpCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState)); 
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR1 |= USART_CR1_RWU;
  }
  else
  {
    /* Disable the USART mute mode by clearing the RWU bit in the CR1 register */
    UART_CONSOLE->CR1 &= (uint16_t)~((uint16_t)USART_CR1_RWU);
  }
}
/**
  ...
  * @retval None.
  */
void USART_WakeUpConfig(USART_TypeDef* UART_CONSOLE, uint16_t USART_WakeUp)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_USART_WAKEUP(USART_WakeUp));
  
  UART_CONSOLE->CR1 &= (uint16_t)~((uint16_t)USART_CR1_WAKE);
  UART_CONSOLE->CR1 |= USART_WakeUp;
}
...
/**
  ...
  * @retval None.
  */
void USART_LINBreakDetectLengthConfig(USART_TypeDef* UART_CONSOLE, uint16_t USART_LINBreakDetectLength)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_USART_LIN_BREAK_DETECT_LENGTH(USART_LINBreakDetectLength));
  
  UART_CONSOLE->CR2 &= (uint16_t)~((uint16_t)USART_CR2_LBDL);
  UART_CONSOLE->CR2 |= USART_LINBreakDetectLength;  
}
...
/**
  ...
  * @retval None.
  */
void USART_LINCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR2 |= USART_CR2_LINEN;
  }
  else
  {
    /* Disable the LIN mode by clearing the LINEN bit in the CR2 register */
    UART_CONSOLE->CR2 &= (uint16_t)~((uint16_t)USART_CR2_LINEN);
  }
}
...
/**
  ...
  * @retval None.
  */
void USART_SendBreak(USART_TypeDef* UART_CONSOLE)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  
  /* Send break characters */
  UART_CONSOLE->CR1 |= USART_CR1_SBK;
}
...
/**
  ...
  * @retval None
  */
void USART_HalfDuplexCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_CR3_HDSEL;
  }
  else
  {
    /* Disable the Half-Duplex mode by clearing the HDSEL bit in the CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_HDSEL);
  }
}
...
/**
  ...
  * @retval None.
  */
void USART_SetGuardTime(USART_TypeDef* UART_CONSOLE, uint8_t USART_GuardTime)
{    
  /* Check the parameters */
  assert_param(IS_USART_123_PERIPH(UART_CONSOLE));
  
  /* Clear the USART Guard time */
  UART_CONSOLE->GTPR &= USART_GTPR_PSC;
  /* Set the USART guard time */
  UART_CONSOLE->GTPR |= (uint16_t)((uint16_t)USART_GuardTime << 0x08);
}
...
/**
  ...
  * @retval None
  */
void USART_SmartCardCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_123_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_CR3_SCEN;
  }
  else
  {
    /* Disable the SC mode by clearing the SCEN bit in the CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_SCEN);
  }
}
...
/**
  ...
  * @retval None.
  */
void USART_SmartCardNACKCmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_123_PERIPH(UART_CONSOLE)); 
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_CR3_NACK;
  }
  else
  {
    /* Disable the NACK transmission by clearing the NACK bit in the CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_NACK);
  }
}
...
/**
  ...
  * @retval None
  */
void USART_IrDAConfig(USART_TypeDef* UART_CONSOLE, uint16_t USART_IrDAMode)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_USART_IRDA_MODE(USART_IrDAMode));
    
  UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_IRLP);
  UART_CONSOLE->CR3 |= USART_IrDAMode;
}
...
/**
  ...
  * @retval None
  */
void USART_IrDACmd(USART_TypeDef* UART_CONSOLE, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_CR3_IREN;
  }
  else
  {
    /* Disable the IrDA mode by clearing the IREN bit in the CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~((uint16_t)USART_CR3_IREN);
  }
}
...
/**
  ...
  * @retval None
  */
void USART_DMACmd(USART_TypeDef* UART_CONSOLE, uint16_t USART_DMAReq, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_USART_ALL_PERIPH(UART_CONSOLE));
  ...
  if (NewState != DISABLE)
  {
    ...
    UART_CONSOLE->CR3 |= USART_DMAReq;
  }
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT and/or
       DMAR bits in the USART CR3 register */
    UART_CONSOLE->CR3 &= (uint16_t)~USART_DMAReq;
  }
}
 ...
 *** Polling Mode ***
 ====================
    ...
    [..] In this Mode it is advised to use the following functions:
         (+) FlagStatus USART_GetFlagStatus(USART_TypeDef* UART_CONSOLE, uint16_t USART_FLAG).
         (+) void USART_ClearFlag(USART_TypeDef* UART_CONSOLE, uint16_t USART_FLAG).
 ...
 *** Interrupt Mode ***
 ======================
    ...
    [..] In this Mode it is advised to use the following functions:
         (+) void USART_ITConfig(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT, 
             FunctionalState NewState).
         (+) ITStatus USART_GetITStatus(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT).
         (+) void USART_ClearITPendingBit(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT).
 ...
 *** DMA Mode ***
 ================
    ...
    [..] In this Mode it is advised to use the following function:
         (+) void USART_DMACmd(USART_TypeDef* UART_CONSOLE, uint16_t USART_DMAReq, 
             FunctionalState NewState).
@endverbatim
  * @{
  */
...
/**
  ...
  * @param  NewState: new state of the specified UART_CONSOLE interrupts.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None.
  */
void USART_ITConfig(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT, FunctionalState NewState)
{
  ...
  usartxbase = (uint32_t)UART_CONSOLE;
...
FlagStatus USART_GetFlagStatus(USART_TypeDef* UART_CONSOLE, uint16_t USART_FLAG)
{
  ...
  if ((UART_CONSOLE->SR & USART_FLAG) != (uint16_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
/**
  * @brief  Clears the UART_CONSOLE's pending flags.
  * @param  UART_CONSOLE: Select the USART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
...
void USART_ClearFlag(USART_TypeDef* UART_CONSOLE, uint16_t USART_FLAG)
{
  ...
  UART_CONSOLE->SR = (uint16_t)~USART_FLAG;
}
...
ITStatus USART_GetITStatus(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT)
{
  ...
  if (usartreg == 0x01) /* The IT  is in CR1 register */
  {
    itmask &= UART_CONSOLE->CR1;
  }
  else if (usartreg == 0x02) /* The IT  is in CR2 register */
  {
    itmask &= UART_CONSOLE->CR2;
  }
  else /* The IT  is in CR3 register */
  {
    itmask &= UART_CONSOLE->CR3;
  }
  
  bitpos = USART_IT >> 0x08;
  bitpos = (uint32_t)0x01 << bitpos;
  bitpos &= UART_CONSOLE->SR;
...
/**
  * @brief  Clears the UART_CONSOLE's interrupt pending bits.
  * @param  UART_CONSOLE: Select the USART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
...
void USART_ClearITPendingBit(USART_TypeDef* UART_CONSOLE, uint16_t USART_IT)
{
  ...
  UART_CONSOLE->SR = (uint16_t)~itmask;
}
